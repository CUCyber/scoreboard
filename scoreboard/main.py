...
def main():
    ...
    httpd = fooster.web.HTTPServer((args.address, args.port), {'/': scoreboard.scoreboard.gen(config, args.template), '/status': scoreboard.scoreboard.gen_json(config)}, sync=scoreboard.sync.manager, log=web_log, http_log=http_log)
